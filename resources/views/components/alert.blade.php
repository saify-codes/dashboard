@switch($type)
    @case('success')
        <div
            ...
            <div class="w-full">
                <h5 class="mb-3 text-lg font-bold text-black dark:text-[#34D399]"> {{ $title }}</h5>
    ...
    @case('error')
        <div
            ...
            <div class="w-full">
                <h5 class="mb-3 text-lg font-bold text-[#B45454]">{{ $title }}</h5>
                <p class="leading-relaxed text-[#CD5D5D]">{{ $message }}</p>
            </div>
        </div>
    @break
@endswitch
